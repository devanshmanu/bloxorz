...
void initGL (GLFWwindow* window, int width, int height)
{
  ...
  for(int i=0;i<105;i++)
  {
   ...
   // printf("create with %d %d %d %d \n",g1,g2,g3,g4 );
    ...
    if (i==11 || i==12 || i==13 || i==14 || i==15 || i==21 || i==22 || i==23 || i==24 || i==28 || i==29 || i==30 || i==31 || i==32 || i==33 || i==38 || i==39 || i==40 || i==41 || i==42|| i== 48 || i==49 || i==50 || i==51|| i== 58 || i==59)
    {
     ...
     // gridkapiece[i].active=0;
      activevariabl2=1;
      gridkapiece[i].active=0;
           // printf("block %d is inactive and x is %d and z is %d \n",i,gridkapiece[i].gridkai, gridkapiece[i].gridkaj );
